...
" компанія заводи будувати не буде.\n\n");
       ...
       // if (M31>0 && M32>0){
        if (M31 > M32) {
            M3 = M31;
            System.out.println("Дохід при події M3.11 вигідніший, ніж при М3.12,  отже, М3.1 = " + M31 +"+ 0*1*"+m3[0]+" + 0*1*"+m3[1]+"-0 = "+ M3); // + Integer.toString((int) M31) + "*" + m3[0] + " = " + (M31 * m3[0]));
        } else {
            M3 = M32;
            System.out.println("Дохід при події M3.12 вигідніший, ніж при М3.11, отже, М3.1 = " + M31 +"+ 0*1*"+m3[0]+" + 0*1*"+m3[1]+"-0 = "+ M3); // + Integer.toString((int) M32) + "*" + m3[0] + " = " + (M32 * m3[0]));
        }
        System.out.println();
        ...
        if (M3<0) {
          ...
          //  M3 = M31 * m3[0];
            System.out.println("Дохід при події M3.1 вигідніший, ніж при М3.2, отже, M3  = M3.1 = " + Integer.toString((int) M31));
        } else {
          //  M3 = M32 * m3[0];
            System.out.println("Дохід при події M3.2 вигідніший, ніж при М3.1, отже, M3 = M3.2 = " + Integer.toString((int) M32));
        }
